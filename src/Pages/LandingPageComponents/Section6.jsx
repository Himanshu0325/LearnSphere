  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Learner outcomes on <b style={{ color: "#0056d2" }}>LearnSphere</b>
        </Text>
        <Text
          fontFamily={"poppins"}
          fontSize={{
        ...
        >
          According to the latest findings from internet's 2025 report,{" "}
          <span>
            <b>an impressive 87% of learners have reported tangible career benefits.</b>
          </span> These include promotions, enhanced job performance, successful job transitions, increased employability, and skill development. LearnSphere extensive curriculum and industry-recognized certifications have played a pivotal role in facilitating the professional growth of learners, equipping them to thrive in today's fiercely competitive job landscape."
        </Text>
        <Flex mt='15px' >
          <Button
            bgColor={"#0056d2"}
